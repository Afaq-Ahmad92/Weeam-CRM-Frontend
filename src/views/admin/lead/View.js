                  ...
                  <GridItem colSpan={{ base: 12, md: 6 }}>
                    <Card>
                      <Grid templateColumns="repeat(12, 1fr)" gap={4}>
                       ...
                       {!isInLeadPool && <><GridItem colSpan={{ base: 12, md: 6 }}>
                          <Text
                            color={"blackAlpha.900"}
                            fontSize="sm"
                            fontWeight="bold"
                        ...
                        <GridItem colSpan={{ base: 12, md: 6 }}>
                          ...
                          <Text>
                            {data?.leadAddress ? data?.leadAddress : "N/A"}
                          </Text>
                        </GridItem>
                      </Grid>
                    </Card>
                    ...
                    <Card>
                      <Grid templateColumns="repeat(12, 1fr)" gap={4}>
                        ...
                        <GridItem colSpan={{ base: 12, md: 6 }}>
                          ...
                          <Text>
                            {data?.leadSource ? data?.leadSource : "N/A"}
                          </Text>
                        </GridItem>
                        <GridItem colSpan={{ base: 12, md: 6 }}>
                          <Text
                        ...
                        <GridItem colSpan={{ base: 12, md: 6 }}>
                          ...
                          <Text>
                            {data?.leadCampaign ? data?.leadCampaign : "N/A"}
                          </Text>
                        </GridItem>
                        <GridItem colSpan={{ base: 12, md: 6 }}>
                          <Text
                        ...
                        <GridItem colSpan={{ base: 12, md: 6 }}>
                          ...
                          <Text>
                            {data?.timetocall ? data?.timetocall : "N/A"}
                          </Text>
                        </GridItem>
                        <GridItem colSpan={{ base: 12, md: 6 }}>
                          <Text
                          ...
                          <Text>
                            {data?.r_u_in_uae ? data?.r_u_in_uae : "N/A"}
                          </Text>
                        </GridItem>
                        <GridItem colSpan={{ base: 12, md: 6 }}>
                          <Text
                    ...
                    <Card>
                      <Grid templateColumns="repeat(12, 1fr)" gap={4}>
                        ...
                        {/* <GridItem colSpan={{ base: 12, md: 6 }}>
                          ...
                          >
                            {" "}
                            Lead Assigned Manager
                          </Text>
                          <Text>
                            {data?.leadAssignedManager
                              ? data?.leadAssignedManager
                              : "N/A"}
                          </Text>
                        </GridItem> */}
                    ...
                    <Card>
                      <Grid templateColumns="repeat(12, 1fr)" gap={4}>
                        ...
                        <GridItem colSpan={{ base: 12, md: 6 }}>
                          ...
                          <Text>
                            {data?.leadScore ? data?.leadScore : "N/A"}
                          </Text>
                        </GridItem>
                        <GridItem colSpan={{ base: 12, md: 6 }}>
                          <Text
